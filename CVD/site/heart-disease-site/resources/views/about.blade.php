                ...
                <div class="col-lg-10">
                    <div class="about-card shadow-sm">
                        ...
                        <div class="about-section mb-5">
                            ...
                            <p>HeartSafe Predictor is a machine learning-based web application developed in 2025 by Avishek
                                Sah for educational and demonstration purposes. This tool predicts the likelihood of heart
                                disease based on various medical parameters provided by users.</p>
                            <p>While this application demonstrates the power of AI in healthcare diagnostics, it's important
                                to note that the predictions are not 100% accurate and should not replace professional
                                medical advice.</p>
                        </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>0: typical angina<br>1: atypical angina<br>2: non-anginal pain<br>3:
                                                asymptomatic</td>
                                        </tr>
                                        <tr>
                                            <td>Resting BP</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>0: normal<br>1: ST-T wave abnormality<br>2: left ventricular hypertrophy
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <div class="about-section">
                            ...
                            <div class="alert alert-info mt-3">
                                ...
                                <strong>Important Note:</strong> This application is for educational purposes only. Always
                                consult with qualified healthcare professionals for medical diagnoses and treatment.
                            </div>
                        </div>
                    </div>
