                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('age') is-invalid @enderror" id="age" name="age"
                            min="20" max="100" value="{{ old('age') }}" required>
                        @error('age')
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('resting_blood_pressure') is-invalid @enderror"
                            id="resting_blood_pressure" name="resting_blood_pressure" min="50" max="200"
                            value="{{ old('resting_blood_pressure') }}" required>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" class="form-control @error('cholesterol') is-invalid @enderror"
                            id="cholesterol" name="cholesterol" min="100" max="500" value="{{ old('cholesterol') }}"
                            required>
                        @error('cholesterol')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
            ...
            <div class="form-section card p-4 fade-in">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-control @error('chest_pain_type') is-invalid @enderror" id="chest_pain_type"
                            name="chest_pain_type" required>
                            <option value="">Select Type</option>
                            <option value="Typical Angina" {{ old('chest_pain_type') == 'Typical Angina' ? 'selected' : '' }}>
                                Typical Angina</option>
                            ...
                            <option value="Asymptomatic" {{ old('chest_pain_type') == 'Asymptomatic' ? 'selected' : '' }}>
                                Asymptomatic</option>
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-control @error('fasting_blood_sugar') is-invalid @enderror"
                            id="fasting_blood_sugar" name="fasting_blood_sugar" required>
                            <option value="">Select Value</option>
                            <option value="<120 mg/dL" {{ old('fasting_blood_sugar') == '<120 mg/dL' ? 'selected' : '' }}>
                                <120 mg/dL</option>
                            <option value=">120 mg/dL" {{ old('fasting_blood_sugar') == '>120 mg/dL' ? 'selected' : '' }}>>120
                                mg/dL</option>
                        </select>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('max_heart_rate_achieved') is-invalid @enderror"
                            id="max_heart_rate_achieved" name="max_heart_rate_achieved" min="60" max="220"
                            value="{{ old('max_heart_rate_achieved') }}" required>
            ...
            <div class="form-section card p-4 fade-in">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-control @error('resting_electrocardiogram') is-invalid @enderror"
                            id="resting_electrocardiogram" name="resting_electrocardiogram" required>
                            <option value="">Select Result</option>
                            <option value="Normal" {{ old('resting_electrocardiogram') == 'Normal' ? 'selected' : '' }}>Normal
                            </option>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-control @error('exercise_induced_angina') is-invalid @enderror"
                            id="exercise_induced_angina" name="exercise_induced_angina" required>
                            <option value="">Select Value</option>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.1" class="form-control @error('st_depression') is-invalid @enderror"
                            id="st_depression" name="st_depression" min="0" max="6.2" value="{{ old('st_depression') }}"
                            required>
                        @error('st_depression')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-control @error('st_slope') is-invalid @enderror" id="st_slope" name="st_slope"
                            required>
                            <option value="">Select Slope</option>
                            <option value="Upsloping" {{ old('st_slope') == 'Upsloping' ? 'selected' : '' }}>Upsloping
                            </option>
                            <option value="Flat" {{ old('st_slope') == 'Flat' ? 'selected' : '' }}>Flat</option>
                            <option value="Downsloping" {{ old('st_slope') == 'Downsloping' ? 'selected' : '' }}>Downsloping
                            </option>
                        </select>
                        @error('st_slope')
                            <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-control @error('num_major_vessels') is-invalid @enderror" id="num_major_vessels"
                            name="num_major_vessels" required>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <select class="form-control @error('thalassemia') is-invalid @enderror" id="thalassemia"
                            name="thalassemia" required>
                            <option value="">Select Type</option>
                            <option value="Normal" {{ old('thalassemia') == 'Normal' ? 'selected' : '' }}>Normal</option>
                            <option value="Fixed Defect" {{ old('thalassemia') == 'Fixed Defect' ? 'selected' : '' }}>Fixed
                                Defect</option>
